...
We apply formula (eq:dynamics) and obtain the evolution of expected churn risk in the next 25 months, as shown in \Cref{fig:dynamics}.

\begin{figure}[!h]
\centering
\includegraphics[scale=.7, trim={0 0 0 0}, clip]{Dynamics.pdf}
