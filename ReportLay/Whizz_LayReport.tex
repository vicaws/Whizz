...
\infommmarginnote[10em]{Dirichlet process mixture is Bayesian and can infer the number of clusters from data.}
...
\end{enumerate}
The benefits of this model choice are massive. Unlike a frequentist's viewpoint, where the observed data as infinitely available as independent replicates, here it can be updated with new data as this comes in. Moreover, it infers the number of clusters from observed data, and opens the opportunities of finding new clusters as more data are observed.
...
\vspace*{-3mm}
\centering
\includegraphics[width=\textwidth, trim={0 10mm 0 0}, clip]{StatesDefinition.pdf}
